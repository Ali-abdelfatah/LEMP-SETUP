...
1- Verify Nginx load balancing by stopping one Nginx server and checking failover.
2- Test database replication by creating a record in the master database and verifying it on the slave 
3- Ensure WordPress is fully functional.-->
